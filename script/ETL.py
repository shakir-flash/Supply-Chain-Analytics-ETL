...
supply_chain_df = pd.read_excel(r'C:\Users\shaki\Documents\VSCode\Supply-Chain-Analytics (ETL)-main\data\raw\supply_chain_data.xlsx')
...
transformed_data.to_csv(r'C:\Users\shaki\Documents\VSCode\Supply-Chain-Analytics (ETL)-main\data\processed\processed_data.csv', index=False)
...
csv_file_path = r'C:\Users\shaki\Documents\VSCode\Supply-Chain-Analytics (ETL)-main\data\processed\processed_data.csv'
